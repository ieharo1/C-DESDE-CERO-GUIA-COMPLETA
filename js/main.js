...
document.addEventListener('DOMContentLoaded', function() {
    ...
    window.addEventListener('scroll', () => {
        ...
        if (window.pageYOffset > 100) {
            header.style.background = 'rgba(104, 121, 140, 0.98)';
            header.style.boxShadow = '0 4px 30px rgba(168, 185, 204, 0.3)';
        } else {
    ...
    console.log('%c⚡ ¡Bienvenido a C Desde Cero!', 'font-size: 20px; color: #A8B9CC; font-weight: bold;');
});
